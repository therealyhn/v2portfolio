...
export default function Navbar() {
    ...
    return (
        <nav
            className={`fixed inset-x-0 top-0 z-50 animate__animated animate__fadeIn transition-all ${scrolled ? "bg-surface/30 dark:bg-surface-2/80 backdrop-blur-sm" : "bg-transparent"
                }`}
        >
