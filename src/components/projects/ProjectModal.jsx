...
export default function ProjectModal({ open, onClose, project }) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-5xl h-[640px] 
      ...
      >
        ...
        {/* Slider */}
        <div className="relative bg-white/70 dark:bg-black/20">
          <div
        ...
        {/* Content */}
        <div className="p-6 grid grid-cols-1 bg-white dark:bg-surface lg:grid-cols-[1.3fr_.7fr] gap-6">
          <div>
